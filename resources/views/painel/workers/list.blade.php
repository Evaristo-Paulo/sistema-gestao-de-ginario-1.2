                                    ...
                                    <tr>
                                        ...
                                        <td class="option-data">
                                            @can('delete')
                                                ...
                                                @else
                                                <a href="{{ route('worker.edit.form', encrypt($worker->id) ) }}" class="btn btn-info"><i class="fa fa-refresh"
                                                    aria-hidden="true"></i> <span class="option-title"></span></a>
        ...
        document.querySelector('.tablePDF').addEventListener('click', () => {
            ...
            doc.autoTable({
                ...
                didDrawPage: function (data) {
                    ...
                    var tableTitle = 'Lista de Funcionários'
            ...
            doc.save("lista-funcionarios.pdf");
        });
    </script>
@endpush
