                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-lg-12 col-md-6">
                                                    <div class="form-wizard">
                                                        <form method="POST" role="form" action="{{  route('worker.register') }}" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            ...
                                                            <fieldset class="wizard-fieldset show">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="text" value="{{ old('bi')}}" name="bi" id="bi">
                                                                        <div class="wizard-form-error"></div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <select class="select2_single form-control  wizard-required" required="required" tabindex="-1" id="ocupation"
                                                                            ...
                                                                            @foreach ($ocupations as $ocupation )
                                                                                @if($ocupation->name == 'Personal Trainer')
                                                            ...
                                                            <fieldset class="wizard-fieldset">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" type="text" required value="{{ old('hood') }}"
                                                                            name="hood" id="hood">
                                                                            <div class="wizard-form-error"></div>
                                                                    </div>
                                                                    <div class="col-sm-6">
