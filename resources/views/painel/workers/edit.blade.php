                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-lg-12 col-md-6">
                                                    <div class="form-wizard">
                                                        <form method="POST" action="{{ route('worker.edit', $worker->id ) }}" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                                        @method('PUT')
                                                            ...
                                                            <fieldset class="wizard-fieldset show">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $worker->name }}"
                                                                            id="name" name="name">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="date" value="{{ $worker->birthday }}"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $worker->bi}}" name="bi" id="bi">
                                                                        <div class="wizard-form-error"></div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <fieldset class="wizard-fieldset">
                                                                <h5>Contacto/Cargo</h5>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        <label for="phone" class="col-form-label">
                                                                            Telefone <span class="required">*</span></label>
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $worker->phone }}"
                                                                            id="phone" name="phone">
                                                                            <div class="wizard-form-error"></div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="email" value="{{ $worker->email }}"
                                                                            name="email" id="email">
                                                                            <div class="wizard-form-error"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        <label for="ocupation" class="col-form-label">
                                                                            Função <span class="required">*</span></label>
                                                                        <select class="select2_single form-control  wizard-required" required="required" tabindex="-1" id="ocupation"
                                                                            name="ocupation">
                                                            ...
                                                            <fieldset class="wizard-fieldset">
                                                                <h5>Endereço/Fotografia</h5>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        <label for="hood" class="col-form-label">
                                                                            Bairro <span class="required">*</span></label>
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $worker->hood }}"
                                                                            name="hood" id="hood">
                                                                            <div class="wizard-form-error"></div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $worker->street }}"
