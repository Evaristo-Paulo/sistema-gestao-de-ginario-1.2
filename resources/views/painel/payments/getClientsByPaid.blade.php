...
Relatório de Pagamento Regularizado -
@endsection
@section('title-page')
Relatório de Pagamento Regularizado
@endsection
                            ...
                            <table  class="text-center table my-table">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3">
                                                <p>Sem pagamentos regularizado</p>
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
        ...
        document.querySelector('.tablePDF').addEventListener('click', () => {
            ...
            doc.autoTable({
                ...
                didDrawPage: function (data) {
                    ...
                    var tableTitle = 'Relatório de Pagamento Regularizado'
            ...
            doc.save("relatorio-pagamento-regularizado.pdf");
        });
    </script>
@endpush
