                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-lg-12 col-md-6">
                                                    <div class="form-wizard">
                                                        <form role="form" method="POST" action="{{ route('client.edit', $client->id ) }}" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            @method('PUT')
                                                            ...
                                                            <fieldset class="wizard-fieldset show">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $client->name }}"
                                                                            id="name" name="name">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="date" value="{{ $client->birthday }}"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $client->bi }}" name="bi" id="bi">
                                                                        <div class="wizard-form-error"></div>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $client->phone }}"
                                                                            id="phone" name="phone">
                                                                            <div class="wizard-form-error"></div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="email" value="{{ $client->email }}"
                                                                            name="email" id="email">
                                                                            <div class="wizard-form-error"></div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <fieldset class="wizard-fieldset">
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $client->hood }}"
                                                                            name="hood" id="hood">
                                                                            <div class="wizard-form-error"></div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <input class="form-control wizard-required" required type="text" value="{{ $client->street }}"
