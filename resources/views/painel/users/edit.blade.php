    ...
    <div class="col-lg-12 col-ml-12">
        ...
        <div class="row">
            <div class="col-12 mt-5">
                ...
                @endif
                <div class="card">
                    <form class="card-body" method="POST" action="{{ route('user.edit', $user->id ) }}">
                        {{ csrf_field() }}
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input class="form-control" required type="text" value="{{ $user->name }}"
                                    id="name" name="name">
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input class="form-control" required type="email" value="{{ $user->email }}"
                                    name="email" id="email">
                            </div>
                        </div>
                        <div class="form-group row">
